const CACHE='basketball-agenda-v74';
const DATA_CACHE='basketball-foys-data-v1';
const SHELL=['./','./index.html','./styles.css?v=3','./club.css?v=2','./all-teams.js?v=5','./live-task-source-v1.js?v=1','./app.js?v=4','./ui-state-v2.js?v=5','./match-rules-v1.js?v=2','./admin-email-guard-v1.js?v=1','./club-v6.js?v=1','./admin-agenda-v4.js?v=1','./task-import-parsers-v1.js?v=1','./task-import-engine-v1.js?v=1','./task-import-ui-v1.js?v=1','./club-members-admin.js?v=9','./feed.js?v=6','./played-match-report-v1.js?v=7','./argon-ui.js?v=7','./presence-ui-v5.js?v=5','./training-manager-v7.js?v=1','./trainer-driving-v1.js?v=3','./agenda-polish-v4.js?v=3','./trainer-agenda-labels-v1.js?v=1','./task-change-labels-v1.js?v=1','./manifest.webmanifest','./data/tasks.json'];
