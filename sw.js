const CACHE='basketball-agenda-v38';
const DATA_CACHE='basketball-foys-data-v1';
const SHELL=['./','./index.html','./styles.css?v=3','./club.css?v=2','./all-teams.js?v=5','./app.js?v=3','./club.js?v=3','./admin-agenda-v2.js?v=2','./club-members-admin.js?v=6','./feed.js?v=6','./argon-ui.js?v=5','./final-fixes.js?v=4','./admin-training.js?v=2','./all-teams-v2.js?v=3','./agenda-polish.js?v=3','./ux-v3.js?v=2','./manifest.webmanifest','./data/tasks.json'];
